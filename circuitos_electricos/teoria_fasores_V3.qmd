...
<div id="panelRec2Pol" class="row g-3 align-items-end">
  <div class="col-md-5">
    <label for="realPart" class="form-label mb-1"><strong>Parte Real $x$ (Resistencia $R$):</strong></label>
    <div class="input-group">
      <span class="input-group-text bg-light fw-bold">Re</span>
      <input id="realPart" type="number" class="form-control" value="3" step="0.5" oninput="calcularDesdeRectangular()">
    </div>
  </div>

  <div class="col-md-5">
    <label for="imagPart" class="form-label mb-1"><strong>Parte Imaginaria $y$ (Reactancia $X$):</strong></label>
    <div class="input-group">
      <span class="input-group-text bg-light fw-bold">+j Im</span>
...
<div id="panelPol2Rec" class="row g-3 align-items-end" style="display: none;">
  <div class="col-md-5">
    <label for="magPart" class="form-label mb-1"><strong>Magnitud o Módulo $r$ ($|\mathbf{Z}|$ o $|\mathbf{V}|$):</strong></label>
    <div class="input-group">
  ...
  <div class="col-md-5">
    <label for="angPart" class="form-label mb-1"><strong>Ángulo de Fase $\theta$ (Grados °):</strong></label>
    <div class="input-group">
      <span class="input-group-text bg-light fw-bold">&ang; &theta;</span>
