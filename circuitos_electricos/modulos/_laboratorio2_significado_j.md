  ...
  <script>
    ...
    function lab2_multiplyJ() {
      ...
      if (lab2_state.step < 4) {
        ...
        /*
         * Después de 360° volvemos a comenzar.
         */
        lab2_state.step = 0;

      }

      lab2_state.operation = "Multiplicar por <i>j</i>";
    ...
    function lab2_multiplyMinusJ() {
      ...
      else if (lab2_state.step === 1) {
        lab2_state.step = 0;
      }

      else if (lab2_state.step === 2) {
        lab2_state.step = 1;
      }

      else if (lab2_state.step === 3) {
        lab2_state.step = 2;
      }

      else if (lab2_state.step === 4) {
        lab2_state.step = 3;
      }
    ...
    function lab2_update() {
      ...
      /*
       * Ecuación correspondiente a cada paso
       */
      ...
      if (equation) {
        ...
        if (lab2_state.step === 0) {
          ...
          html = "1 &times; <i>j</i> = <i>j</i>";

        }

        else if (lab2_state.step === 2) {

          html = "<i>j</i> &times; <i>j</i> = <i>j</i><sup>2</sup> = -1";
      ...
      const messages = [
...

        {
          ...
          insightTitle: "Observa",
          text:
            "Al multiplicar por <i>j</i>, el vector gira exactamente " +
            "+90&deg;: 1 &rarr; <i>j</i>. " +
            "La magnitud permanece igual."
        },

        {
          ...
          insightTitle: "Observa",
          text:
            "Otra multiplicación por <i>j</i> produce otra rotación de " +
            "+90&deg;: <i>j</i> &rarr; -1. " +
            "Algebraicamente, esto es <i>j</i><sup>2</sup> = -1."
        },

        {
          ...
          insightTitle: "Observa",
          text:
            "El vector vuelve a girar +90&deg;: " +
            "-1 &rarr; -<i>j</i>. " +
            "La dirección ha avanzado hasta 270&deg;."
        },

        {
          title: "Una vuelta completa",
          insightTitle: "Comprueba",
          text:
            "Después de cuatro multiplicaciones por <i>j</i>, " +
            "el vector regresa a su posición inicial. " +
            "Por eso <i>j</i><sup>4</sup> = 1: cuatro rotaciones de +90&deg; " +
            "forman una vuelta completa de 360&deg;."
        }
      ...
      if (title)
        title.textContent =
          messages[lab2_state.step].title;

      if (insightTitle)
        insightTitle.textContent =
          messages[lab2_state.step].insightTitle;

      if (insightText)
        insightText.innerHTML =
          messages[lab2_state.step].text;
